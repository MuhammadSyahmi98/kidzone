...
$sql = "SELECT * FROM content where content_level = '2'";
            ...
            <div class="row" style="display: inline-block;">
              <div class="column" >
                <div style="width: 450px; padding: 10px 5px; border-radius: 30px;" class="card">
                     ...
                     <tr><td><center><a href="content.php?content=<?php echo $contentid; ?>"><img src="img/subject/year2/<?php  echo $row['content_img']; ?>" style="width: 150px; height: 200px; "></a></center></td></tr><br>
