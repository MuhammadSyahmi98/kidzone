...
if (isset($_POST['add'])) {
    header('location: tambahstaff.php');
}
?>
        ...
        <div class="hk-pg-wrapper">
            <div class="container mt-xl-50 mt-sm-30 mt-15">
                ...
                <div class="hk-pg-header align-items-top">
                    <div>
                        <h2 class="hk-pg-title font-weight-600 mb-10">List of Staff</h2>
                                    ...
                                    <div class="table-wrap">
                                        <form method="POST">
                                            <div style="float: right;" class="mb-10">
                                                <button type="submit" name="add" class="btn btn-primary"><a style="color: white;" href="tambahstaff.php">Add Staff</a></button>
                                            </div>
                                        </form>
                                        <table id="datable_6" class="table table-hover pb-30">
                                            <thead>
                                                <tr>
                                                    <th>Name</th>
                                                    <th>IC No.</th>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) { ?>
                                                        <tr>
                                                            ...
                                                            <td><a href="managestaff.php?id=<?php echo $row['staff_id']; ?>">Update</a></td>
