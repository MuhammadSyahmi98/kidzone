...
$sql = "SELECT * FROM content where content_level = '4'";
...
<body>
  ...
  <center>
    <h1 style="color: #000080; font-family:  helvetica; margin-top: 5%">Course </h1>
  </center>
  <br>
      ...
      <div class="row" style="display: inline-block;">
        <div class="column">
          <div style="width: 450px; padding: 10px 5px; border-radius: 30px;" class="card">
            ...
            <tr>
              <td>
                <center><a href="content.php?content=<?php echo $contentid; ?>"><img src="img/subject/year4/<?php echo $row['content_img']; ?>" style="width: 150px; height: 200px; "></a></center>
              </td>
            </tr><br>

            <tr>
              <td><input type="text" style="border: none; text-align: center; font-size: 30px; width: 100%;" name="contentname" value="<?php echo $contentname; ?>" disabled></td>
            </tr>
